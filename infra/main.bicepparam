...
param cognitiveServicesAccountName = readEnvironmentVariable('COGNITIVE_SERVICES_ACCOUNT_NAME', 'wai-test-project-demo1-resource')
param cognitiveServicesResourceGroup = readEnvironmentVariable('COGNITIVE_SERVICES_RESOURCE_GROUP', 'rg-wai')
